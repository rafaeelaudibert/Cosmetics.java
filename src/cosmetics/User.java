...
public class User {
	...
	public boolean canEvaluate(Product product) {
		...
		if (this.getEvaluationsFromGroup(product.getGroup()) != null) {
			if (this.getEvaluationsFromGroup(product.getGroup()).stream().anyMatch((Evaluation e) -> e.getProduct() == product)) {
				return false;
			}
		}
		return true;
