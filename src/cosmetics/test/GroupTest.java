...
public class GroupTest {
	User userJoao, userAna, userManoela, userJoana, userMiguel, userBeatriz, userSuzana, userNatasha, userPedro,
			userCarla;
	...
	Product avonCCCream, revolutionPowderSunscreen, maybellineBBCream, revlonFoundationSPF20, niveaMatteFaceSPF,
			laRocheCCCream, yvesRocherPowderSPF15, niveaBBCream, baseOBoticarioSPF20, naturaSPF20RostoMatte;
	...
	public void setUp() throws BusinessException {
		...
		// Adicionando usuários aos grupos (não precisamos pegar a exceção pois é
		// garantido disso funcionar)
	...
	// Test getAcceptableProducts & getNotAcceptableProducts
	@Test
